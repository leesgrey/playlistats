                ...
                <div id="graphContainer">
                  <div className="graphBlock full">
                    ...
                    <div style={{ margin: '0 auto', width: '20rem', marginBottom: '0.5rem' }}>
                      <select style={{ width: '10rem' }} onChange={(e) => this.setState({ customX: e.target.value })}>
                      ...
                      <select style={{ width: '10rem' }} onChange={(e) => this.setState({ customY: e.target.value })}>
                        <option value={null}>none</option>
                        <option value="acousticness">acousticness</option>
                        <option value="danceability">danceability</option>
                        <option value="energy">energy</option>
                    ...
                    <CustomGraph id={this.props.bleh} customX={this.state.track_features.audio_features.map((i) => i[this.state.customX])} customY={this.state.track_features.audio_features.map((i) => i[this.state.customY])} labels={this.state.track_objects.items.map((i) => `${i.track.name} - ${i.track.artists[0].name}`)} xLabel={this.state.customX} yLabel={this.state.customY} />
                  </div>
